...
| **Mise en Place** | Setup | Configuring CLI, MCP, project mappings, and compatibility environment |
...
| **API Token** | Compatibility bearer token for shell-helper mode or direct REST automation (prefix: `preq_`) |
