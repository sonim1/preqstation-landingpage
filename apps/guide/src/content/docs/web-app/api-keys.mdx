...
The recommended Claude Code and Codex MCP setup now uses the remote PREQSTATION endpoint at `/mcp` and browser OAuth.
...
### Token-Based Shell Helper or Legacy Local Bridge

Use API tokens when you need shell-helper mode or the legacy local stdio bridge. Configure your environment like this:
...
If you must use the legacy local bridge, the MCP configuration looks like this:
