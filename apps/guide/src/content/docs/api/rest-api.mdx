...
| Method | Endpoint | Purpose |
|---|---|---|
| `POST` | `/telegram/send` | Send task Telegram message to OpenClaw or Hermes |
| `POST` | `/telegram/send/insight` | Send project insight to OpenClaw or Hermes |
...
| `POST` | `/telegram/test` | Send OpenClaw or Hermes Telegram test message |
