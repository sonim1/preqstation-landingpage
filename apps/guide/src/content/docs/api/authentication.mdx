...
PREQSTATION uses session cookies for the web UI, OAuth-backed MCP connections for Claude Code and Codex, and bearer tokens only for shell-helper compatibility or direct REST automation.
