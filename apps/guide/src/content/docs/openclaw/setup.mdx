---
title: Setup
description: Install and configure preqstation-openclaw for PREQ task execution
---
...
Use this page only if you want the **legacy OpenClaw ingress**. For direct Claude Code dispatch from the PREQSTATION web app, use the `preqstation-skill` plugin + dispatch channel path instead.
