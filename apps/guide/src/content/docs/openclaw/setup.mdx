...
Use this page when you want the **OpenClaw dispatcher** path. If you want the web app's **Claude Code dispatcher** path instead, use the `preqstation-skill` plugin + dispatch channel setup.
