...
const ko: typeof en = {
  meta: {
    title: "PreqStation \u2014 AI \uc5d0\uc774\uc804\ud2b8 \uc2e4\ud589 \ud50c\ub7ab\ud3fc",
  ...
  nav: {
    ...
    sections: [
      ...
      { id: "problem", label: "\ubb38\uc81c" },
      { id: "solution", label: "\uc8fc\ubc29 \ubaa8\ub378" },
      { id: "who", label: "\ub204\uac00 \uc4f0\ub098" },
      { id: "features", label: "\uc2a4\ud1a0\ub9ac" },
      { id: "why-preq", label: "\ucca0\ud559" },
  ...
  hero: {
    badge: "\uac1c\ubc1c\uc790\uc758 \uc8fc\ubc29",
    title: "\ud0dc\uc2a4\ud06c\ub97c \ud050\uc5d0 \ub123\uc73c\uc138\uc694.\n\uc5d0\uc774\uc804\ud2b8\uac00 \uc2e4\ud589\ud569\ub2c8\ub2e4.",
    description: "PreqStation은 하루 종일 컴퓨터 앞에 있을 수 없는 개발자를 위해 만들었습니다. 컨트롤 플레인에서 태스크를 준비하고, PREQ CLI로 로컬 운영자 호스트를 점검한 뒤, 웹 앱이나 통합, 또는 필요할 때 direct CLI로 dispatch하세요. 이후 Claude, Codex, Gemini가 남긴 리뷰 가능한 증거로 돌아오면 됩니다.",
  ...
  problem: {
    ...
    painPoints: [
      {
        icon: "\ud83d\udcf1",
        title: "\ud558\ub8e8 \uc885\uc77c \ucef4\ud4e8\ud130 \uc55e\uc5d0 \uc549\uc544 \uc788\uc744 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4",
        desc: "\uc791\uc5c5 \uc544\uc774\ub514\uc5b4\ub294 \uc774\ub3d9 \uc911\uc774\ub098 \ubbf8\ud305 \uc0ac\uc774\uc5d0\ub3c4 \ub098\uc635\ub2c8\ub2e4. \uadf8 \ub54c \ud0dc\uc2a4\ud06c\ub97c \uc900\ube44\ud558\uace0 \ub098\uc911\uc5d0 \uc2e4\ud589\ud560 \uc218 \uc788\uc5b4\uc57c \ud750\ub984\uc774 \ub04a\uae30\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4.",
      },
      {
        icon: "\ud83e\uddd1\u200d\ud83d\udcbb",
        title: "\ub300\ubd80\ubd84\uc758 \ud2b8\ub798\ucee4\ub294 \ub354 \ud070 \uc0ac\ub78c \ud300\uc744 \uae30\uc900\uc73c\ub85c \ud569\ub2c8\ub2e4",
        desc: "\ud070 \uc870\uc9c1\uc5d0\ub294 \uc798 \ub9de\uc744 \uc218 \uc788\uc5b4\ub3c4, 1\uc778 \uac1c\ubc1c\uc790\uc640 \uc791\uc740 \ud300\uc5d0\uac8c\ub294 \ubb34\uac70\uc6b4 \ud504\ub85c\uc138\uc2a4\ubcf4\ub2e4 \uac00\ubcbc\uc6b4 \uc2e4\ud589 \uaddc\uc728\uc774 \ub354 \ud544\uc694\ud569\ub2c8\ub2e4.",
      },
      {
        icon: "\ud83d\udea7",
        title: "MVP\ub294 \uc26c\uc6cc\uc84c\uc9c0\ub9cc \ud504\ub85c\ub355\uc158 \ud6c4\uc18d \uc791\uc5c5\uc740 \uc5ec\uc804\ud788 \uc5b4\ub835\uc2b5\ub2c8\ub2e4",
        desc: "\uc5d0\uc774\uc804\ud2b8\uac00 \ub9cc\ub4e0 \uc720\ub9dd\ud55c \ucd08\uc548\uc744 \uaca9\ub9ac\ub41c \ubcc0\uacbd, \ubcf4\uc774\ub294 \uc99d\uac70, \uc548\uc804\ud55c \ub9ac\ubdf0 \uac00\ub2a5 \uc0c1\ud0dc\ub85c \ubc14\uafb8\ub294 \uac83\uc774 \uc5b4\ub824\uc6b4 \ubd80\ubd84\uc785\ub2c8\ub2e4.",
      },
    ],
    stats: [
  ...
  solution: {
    ...
    proof: {
      ...
      taskSummary: "PreqStation은 태스크의 범위, 담당 엔진, 리뷰 기준을 유지하고, PREQ CLI는 작업자나 dispatch를 실행할 로컬 호스트를 준비합니다.",
      criteriaLabel: "\uac80\uc99d \uae30\uc900",
      criteria: [
        "PreqStation에서 태스크를 큐에 넣고 준비",
        "PREQ CLI로 운영자 호스트 설치 및 점검",
        "웹 앱, 통합, direct CLI 중 맞는 경로로 dispatch",
      ],
      meta: [
        { label: "\ud560\ub2f9 \uc5d4\uc9c4", value: "Codex" },
        { label: "호스트 점검", value: "preqstation doctor" },
        { label: "리뷰 게이트", value: "notes + tests + branch/PR" },
      ],
      evidenceTitle: "\ub9ac\ubdf0 \uc99d\uac70",
      evidence: [
        { label: "\ube0c\ub79c\uce58", value: "task/pqsl-11/..." },
        { label: "산출물", value: "구현 노트와 테스트가 PREQ로 반환" },
        { label: "다음 단계", value: "리뷰 증거를 보고 머지, 배포, 후속 작업 결정" },
      ],
    },
    chefHeader: "\ud83e\uddd1\u200d\ud83c\udf73 \uc178\ud504\uc758 \uc5ed\ud560",
    chefItems: [
    ...
    aiHeader: "\ud83e\udd16 AI \uc694\ub9ac\uc0ac\uc758 \uc5ed\ud560",
    aiItems: [
      { title: "\ubc94\uc704 \uc815\ub9ac\ub41c \uc791\uc5c5 \uc778\uc218", desc: "run_state\ub85c inbox\ub97c \uacc4\ud68d\ud558\uac70\ub098 todo/hold \uc791\uc5c5\uc744 claim" },
      { title: "준비된 호스트에서 실행", desc: "매핑된 프로젝트, 격리된 worktree, 선택한 Claude, Codex, Gemini 런타임 사용" },
      { title: "\uc99d\uac70 \ubc18\ud658", desc: "\ub178\ud2b8, \ud14c\uc2a4\ud2b8, \ube0c\ub79c\uce58/PR \uc815\ubcf4\ub97c \uc81c\ucd9c\ud574 \ub9ac\ubdf0\uac00 \uac10\uc73c\ub85c \ud750\ub974\uc9c0 \uc54a\uac8c \ud569\ub2c8\ub2e4." },
    ],
    bottomMessage: "\ud1b5\uc81c\uad8c\uc740 \ub2f9\uc2e0\uc5d0\uac8c \uc788\uc2b5\ub2c8\ub2e4.",
  },
  whyPreq: {
    title: "PreqStation — 왜 이게 필요한가",
    intro: "PreqStation은 프로젝트 관리 전부를 대체하려는 도구가 아닙니다. 이미 무엇을 해야 할지 아는 개발자가, 그 작업을 AI 에이전트에게 깔끔하게 넘기고 결과를 리뷰하기 위한 실행 계층입니다.",
    problemLabel: "문제",
    solutionLabel: "해결",
    sections: [
      {
        id: "dispatch",
        title: "1. 어디서든 Dispatch — 삶이 있는 사람을 위한 도구",
        problem: [
          "좋은 작업 아이디어는 항상 책상 앞에서만 오지 않습니다. 이동 중이거나, 다른 프로젝트를 보는 중이거나, 손이 비어 있지 않은 순간에 더 자주 떠오릅니다.",
          "그 순간을 채팅이나 메모 여러 곳에 흩어 놓으면, 나중에는 컨텍스트가 사라지고 handoff를 처음부터 다시 만들어야 합니다.",
        ],
        solution: [
          "PREQ는 작업이 떠오른 순간 바로 범위를 잡고, 필요한 컨텍스트를 남기고, 준비가 되면 dispatch할 수 있게 합니다.",
          "그 결과 실행은 사라지는 대화가 아니라 다시 돌아올 수 있는 태스크 기록으로 남습니다.",
        ],
      },
      {
        id: "small-teams",
        title: "2. Solo & Small Teams — 과한 프로세스 없이 실행만 정리",
        problem: [
          "작은 팀과 1인 개발자에게는 이미 계획을 하는 곳이 있습니다. 그런데 실제 작업 handoff까지 해결해주지 못하는 도구를 하나 더 닫는 것은 도움이 안 됩니다.",
          "필요한 건 조직도를 크게 그리는 시스템이 아니라, 준비된 작업을 에이전트가 실행하고 사람이 리뷰할 수 있는 깔끔한 흐름입니다.",
        ],
        solution: [
          "PREQ는 범위가 확정된 실행 작업, 가벼운 협업, 그리고 보이는 리뷰 신호에만 집중합니다.",
          "백로그 계획은 GitHub Issues, Linear, Jira에 두고, PREQ는 작업이 실행 준비를 마친 순간에만 등장하게 하는 것입니다.",
        ],
      },
      {
        id: "production",
        title: "3. MVP에서 Production으로 — 초안을 배포 가능한 결과로",
        problem: [
          "지금은 AI로 첫 초안을 만드는 것 자체는 어렵지 않습니다. 정말 비싼 부분은 그 결과를 안전하게 리뷰하고 싶을 수 있는 상태로 바꾸는 일입니다.",
          "격리된 worktree, 명시적 리뷰 게이트, 그리고 태스크에 붙은 증거가 없으면 그 비용은 매번 사람이 직접 짊어지게 됩니다.",
        ],
        solution: [
          "PREQ는 그 비용이 드는 부분을 정리해줍니다. 제어된 실행 환경, 실제 워크플로우 상태, 리뷰 증거가 한 태스크에 같이 남습니다.",
          "그래서 빠른 MVP 에너지가 한 번 쓰고 버려지는 초안이 아니라, 프로덕션으로 이어지는 작업으로 바뀌어 갑니다.",
        ],
      },
    ],
  },
  features: {
    title: "\uc138 \uac00\uc9c0 \uc81c\ud488 \uc2a4\ud1a0\ub9ac",
    subtitle: "PreqStation\uc774 \ud544\uc694\ud55c \uc21c\uac04\uc740 \uc601\ub9ac\ud55c \ud504\ub86c\ud504\ud2b8\ubcf4\ub2e4 \ub354 \ub9ce\uc774 \ud544\uc694\ud558\uace0, \uac70\ub300\ud55c \ud504\ub85c\uc138\uc2a4 \uc2a4\ud0dd\ubcf4\ub2e4\ub294 \uc801\uac8c \ud544\uc694\ud560 \ub54c\uc785\ub2c8\ub2e4.",
    items: [
      {
        ...
        bullets: [
          ...
          "사라진 채팅 기록 대신 태스크 가능 정보와 증거가 남은 기록으로 돌아옵니다.",
        ],
      },
      {
        id: "solo-small-teams",
        ...
        bullets: [
          ...
          "queued, working, done을 빠른 멘탈 모델로 보되, 그 뒤에 없는 방대한 조직 구조를 가정하지 않습니다.",
        ],
      },
      {
        ...
        bullets: [
          ...
          "queued, working, done을 빠른 멘탈 모델로 쓰더라도, 실제 리뷰와 완료 판단은 구체적인 증거에 기반합니다.",
        ],
      },
    ],
  },
  pipeline: {
    title: "\uc2e4\ud589 \uc6cc\ud06c\ud50c\ub85c\uc6b0",
    subtitle: "태스크를 준비하고, 운영자 호스트를 점검하고, 작업자를 dispatch한 뒤, 증거를 리뷰하고 Done으로 옮깁니다.",
    targetBadge: "\ub300\uc0c1: \uc9c1\uc811 \uc2e4\ud589",
    steps: [
      { id: "inbox", label: "Inbox", icon: "\ud83d\udce5", title: "작업 큐에 넣기", desc: "범위, 검증 기준, 선택할 작업자 엔진을 남깁니다." },
      { id: "todo", label: "Todo", icon: "\ud83d\uddc2\ufe0f", title: "호스트 준비", desc: "PREQ CLI 설치, doctor 점검, 프로젝트 매핑을 실행합니다." },
      { id: "hold", label: "Hold", icon: "\u23f8\ufe0f", title: "막힌 부분 해결", desc: "매핑, 런타임, 리뷰 입력이 부족하면 잠시 멈춥니다." },
      { id: "ready", label: "Ready", icon: "\ud83d\udc40", title: "증거 리뷰", desc: "머지 전 노트, 테스트, 브랜치, PR 산출물을 확인합니다." },
      { id: "done", label: "Done", icon: "\u2705", title: "결과 배포", desc: "리뷰된 결과가 승인된 뒤 Done으로 옮깁니다." },
    ],
    blocked: "Run-state \uc624\ubc84\ub808\uc774",
    blockedTooltip: "dispatch \uc694\uccad \uc2dc\uc5d0\ub294 queued, \uc5d0\uc774\uc804\ud2b8\uac00 claim\ud558\uba74 working\uc744 \uc4f0\uc138\uc694. \uc0c1\ud0dc \uc704\uc5d0 \uacb9\uccd0 \ud45c\uc2dc\ub418\uc9c0, \uac00\uc9dc \uc6cc\ud06c\ud50c\ub85c\uc6b0 \uceec\ub7fc\uc744 \ub9cc\ub4e4\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4.",
    notTrackerTitle: "\uc774\uc288 \ud2b8\ub798\ucee4\uac00 \uc544\ub2d9\ub2c8\ub2e4",
    notTrackerDescription: "\uc791\uc5c5\uc744 \ubc1c\uacac\ud558\uace0 triage\ud558\ub294 \uac74 GitHub Issues, Linear, Jira\uc5d0 \ub9e1\uae30\uc138\uc694. PREQ\ub294 \ud0dc\uc2a4\ud06c\uac00 \uc548\uc804\ud558\uac8c \uc2e4\ud589\ub420 \uc218 \uc788\ub3c4\ub85d \uc815\ub9ac\ub418\uc5c8\uc744 \ub54c \uc2dc\uc791\ud569\ub2c8\ub2e4.",
  },
  multiEngine: {
    title: "\ud0dc\uc2a4\ud06c\uc5d0 \ub9de\ub294 AI\ub97c \uc120\ud0dd\ud558\uc138\uc694",
    subtitle: "Direct CLI, 웹, OpenClaw, Hermes, Telegram은 dispatch 경로이고, 작업자 엔진은 별도로 선택합니다.",
    engines: [
      {
        accent: "bg-[#C15F3C]", logo: "C", logoBg: "bg-[#C15F3C]",
        name: "Claude Code", company: "Anthropic",
        desc: "복잡한 변경, 리뷰, 로컬 작업자 실행에 강한 범용 엔진이 필요할 때 잘 맞습니다.",
        bestFor: ["범용 태스크", "복잡한 리팩터링", "리뷰"],
      },
      {
        accent: "bg-[#00A67E]", logo: "Cx", logoBg: "bg-[#00A67E]",
        name: "Codex CLI", company: "OpenAI",
        desc: "구현, 리뷰, 반복 실행, 매핑된 운영자 호스트의 direct CLI 실행에 잘 맞는 PREQ 작업자입니다.",
        bestFor: ["구현", "코드 리뷰", "Direct CLI"],
      },
      {
        accent: "bg-[#078EFA]", logo: "G", logoBg: "bg-[#078EFA]",
        name: "Gemini CLI", company: "Google",
        desc: "운영자 호스트에 런타임이 설치되어 있을 때 UI, 문서, 큰 컨텍스트 작업에 잘 맞는 PREQ 작업자입니다.",
        bestFor: ["UI/UX 디자인", "문서 작업", "큰 컨텍스트"],
      },
    ],
  },
  whoIsItFor: {
    ...
    forYou: {
      title: "이런 분께 필요합니다",
      items: [
        { icon: "📱", title: "이동 중 아이디어", desc: "작업이 떠오른 순간 범위를 잡고, 호스트가 준비되면 dispatch합니다." },
        { icon: "⚡", title: "멀티 프로젝트 운영", desc: "여러 저장소를 매핑하고 각 PREQ 태스크에 프로젝트 컨텍스트를 붙여 둡니다." },
        { icon: "🧠", title: "컨텍스트 스위칭", desc: "채팅 세션을 다시 복원하지 않고 노트, 실행 상태, 브랜치 증거로 돌아옵니다." },
        { icon: "🤖", title: "엔진별 전략 운영", desc: "dispatch 경로를 고른 뒤 태스크마다 Claude, Codex, Gemini를 선택합니다." },
        { icon: "✅", title: "품질 중심 개발자", desc: "완료 처리 전에 노트, 테스트, 브랜치, PR을 검토합니다." },
      ],
    },
    notForYou: {
      title: "상황에 맞는 설정 경로",
      items: [
        { icon: "🧭", title: "처음 설정하는 로컬 운영자", desc: "빠른 시작에서 PREQ CLI를 설치하고 doctor 점검과 프로젝트 매핑을 진행하세요." },
        { icon: "🏗️", title: "웹 앱을 셀프 호스팅하는 경우", desc: "dispatch를 붙이기 전에 Web App Setup으로 마이그레이션, owner login, 태스크 컨트롤 플레인을 준비하세요." },
        { icon: "🛠️", title: "워커 전용 fallback", desc: "CLI가 런타임을 등록하지 못하거나 직접 worker 접근만 원할 때 수동 MCP/worker 설정을 사용하세요." },
        { icon: "📡", title: "고급 디스패처 호스트", desc: "준비된 호스트가 원격 dispatch를 받아야 할 때 OpenClaw, Hermes, Telegram을 추가하세요." },
      ],
    },
  },
  pricing: {
    ...
    items: [
      {
        ...
        answer: "\ubcd1\ud569\uc774\ub098 \ubc30\ud3ec \uc804\uc5d0\ub294 \ud56d\uc0c1 \uc0ac\ub78c\uc774 \uac80\ud1a0\ud569\ub2c8\ub2e4. work_logs\uc5d0\ub294 \ubb34\uc5c7\uc774 \uc2e4\ud589\ub418\uace0 \ubb34\uc5c7\uc774 \ubc14\ub00c\uc5c8\ub294\uc9c0 \ub0a8\uc2b5\ub2c8\ub2e4.",
      },
      {
        question: "\ub370\uc774\ud130\ub294 \uc5b4\ub514\uc5d0 \uc800\uc7a5\ub418\ub098\uc694?",
        answer: "self-hosted\ub85c \uc4f0\uba74 \uc11c\ubc84\uc5d0 \uc800\uc7a5\ub429\ub2c8\ub2e4. \ub370\uc774\ud130\ub294 \ub2f9\uc2e0 \ud658\uacbd \uc548\uc5d0 \ub0a8\uc2b5\ub2c8\ub2e4.",
      },
      {
        question: "\uc65c due date\uac00 \uc5c6\ub098\uc694?",
        answer: "\uc774 \uc2dc\uc2a4\ud15c\uc740 \ub9c8\uac10\uc77c\ubcf4\ub2e4 \uc2e4\ud589 \uc0c1\ud0dc\ub97c \ubcfc \uc218 \uc788\uac8c \ud569\ub2c8\ub2e4. \uc900\ube44\ub41c \uc791\uc5c5\uc740 \ubc14\ub85c \ud050\uc5d0 \ub123\uc5b4 \uc2e4\ud589\ud558\uc138\uc694.",
      },
      {
        question: "\uc5b4\ub5a4 AI\ub97c \uc0ac\uc6a9\ud558\ub098\uc694?",
        answer: "Claude Code, Codex CLI, Gemini CLI를 작업자 엔진으로 선택할 수 있습니다. Direct CLI, 웹, OpenClaw, Hermes, Telegram은 dispatch 경로이지 엔진 제한이 아닙니다.",
      },
      {
        question: "\uc624\ud508\uc18c\uc2a4\ub77c\uc11c \ubcf4\uc548\uc774 \ub0ae\uc9c0 \uc54a\ub098\uc694?",
        answer: "\ucf54\ub4dc\uac00 \uacf5\uac1c\ub418\uc5b4 \uc788\uc5b4\uc11c \uc810\uac80\uc774 \uc26c\uc6b4 \ud3b8\uc785\ub2c8\ub2e4. PREQ\ub294 \uadf8 \uc704\uc5d0\ub3c4 Row Level Security, \uc554\ud638\ud654, \uaca9\ub9ac\ub41c worktree \uc2e4\ud589\uc744 \uc4f0\uc2b5\ub2c8\ub2e4.",
      },
    ],
  },
  cta: {
    title: "\uc9c0\uae08 \ub2f9\uc2e0\uc758 \uc8fc\ubc29\uc744 \uc5f4\uc5b4\ubcf4\uc138\uc694",
    subtitle: "빠른 시작으로 운영자 호스트를 준비하고, 프로젝트를 매핑하고, 작업자를 dispatch한 뒤 PreqStation에서 반환된 증거를 리뷰하세요.",
    proof: {
      eyebrow: "현재 설정 증거",
      title: "설치, 점검, 매핑, dispatch, 리뷰",
      checklistLabel: "운영자 호스트 체크리스트",
      checklist: [
        "npx -y @sonim1/preqstation@latest install",
        "preqstation doctor",
        "preqstation setup auto",
        "웹 앱, 통합, direct CLI 중 맞는 경로로 dispatch",
        "PreqStation에서 노트, 테스트, 브랜치, PR 증거 리뷰",
      ],
      linksLabel: "\ucee4\ub9e8\ub4dc \uc13c\ud130",
      links: [
