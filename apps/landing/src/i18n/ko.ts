...
const ko: typeof en = {
  ...
  whoIsItFor: {
    ...
    notForYou: {
      title: "이런 분은 안 필요합니다",
      items: [
        { icon: "📋", title: "단순 이슈 트래커", desc: "원시 백로그 관리는 GitHub Issues, Linear, Jira가 더 맞습니다. PREQ는 이미 범위가 정리된 태스크를 전제로 합니다." },
        { icon: "👥", title: "팀 협업 도구", desc: "일반 협업은 Notion이나 Asana가 먼저고, PREQ는 실행 단계에서 붙는 도구입니다." },
        { icon: "🚫", title: "AI 코딩을 안 함", desc: "Preq는 AI 기반 워크플로우용이에요" },
        { icon: "🐢", title: "프로젝트 하나만", desc: "여러 프로젝트를 동적으로 운영할 때 최적" },
        { icon: "📅", title: "스프린트 관리", desc: "PREQ는 태스크를 실행하는 도구지, 로드맵이나 스프린트 계획을 대체하지는 않습니다." },
      ],
    },
  },
  pricing: {
