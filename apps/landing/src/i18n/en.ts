export default {
  ...
  hero: {
    ...
    description: "PREQSTATION is a self-hosted execution platform for Claude, Codex, and Gemini. Tasks move through inbox, todo, hold, ready, and done while queued and working stay separate as run-state overlays.",
  ...
  solution: {
    ...
    aiItems: [
      { title: "Plan the task", desc: "Move inbox to todo" },
      { title: "Implement safely", desc: "Work in an isolated worktree" },
      { title: "Report results", desc: "Submit notes, tests, and branch or PR info" },
    ],
  ...
  whyPreq: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "See exactly how much work was done per project \u2014 AI hours, completed tasks, and execution logs. Full visibility.",
      },
    ],
  },
  features: {
    title: "Essential Workflow Tools",
    subtitle: "Capture, execute, verify",
    items: [
      {
        number: "01",
        icon: "\ud83d\udccb",
        title: "Capture the task",
        desc: "Create an inbox task from the web app, or relay one from Telegram when you're away from your desk.",
      },
      {
        number: "02",
        icon: "\ud83d\udd25",
        title: "Claim and execute",
        desc: "Agents claim work with run_state, use isolated worktrees, and move todo or hold into ready when implementation is complete.",
      },
      {
        number: "03",
        icon: "\u2705",
        title: "Verify before done",
        desc: "Review ready tasks, run checks, and move them to done only after verification passes.",
      },
    ],
  },
  pipeline: {
    title: "The Current Workflow",
    subtitle: "Five active columns, with queued and working tracked separately",
    steps: [
    ...
    blockedTooltip: "Queued and working sit on top of a task's status. They are not separate workflow columns.",
  },
  multiEngine: {
  ...
  cta: {
    ...
    subtitle: "Read the guide, connect your agents, and verify work before it reaches done.",
