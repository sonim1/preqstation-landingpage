export default {
  meta: {
    ...
    description: "Submit a task. AI preps it. An open-source AI agent execution platform that solves the Last Mile of vibe coding.",
  },
  nav: {
    github: "GitHub",
    cta: "Start Prepping",
  ...
  hero: {
    ...
    tickets: [
      { number: "#3953", task: "Rate Limit API", status: "Cooking...", statusEmoji: "\ud83d\udd25", dotColor: "bg-warm-yellow" },
      { number: "#3954", task: "Auth Refactor", status: "In Queue", statusEmoji: "\u23f3", dotColor: "bg-steel" },
      { number: "#3955", task: "Deploy Script", status: "Done", statusEmoji: "\u2705", dotColor: "bg-mint" },
    ],
  },
  problem: {
    title: "The last puzzle piece of vibe coding is missing",
    subtitle: "AI writes great code. But...",
    painPoints: [
      { icon: "\ud83d\udccb", title: "Task management exists, but no automation", desc: "Context switching, missed tasks" },
      { icon: "\ud83e\udd16", title: "AI exists, but no execution environment", desc: "No parallelism, inefficiency" },
      { icon: "\u2699\ufe0f", title: "Even simple tasks require manual work", desc: "3-hour builds, 4-day deploys" },
      { icon: "\u23f0", title: "Precious time is wasted in between", desc: "Prototype \u2192 Production: 10-30x" },
    ],
    stats: [
  ...
  solution: {
    ...
    chefItems: [
      { title: "Write tasks", desc: "Define what to build" },
      { title: "Final review", desc: "Review AI results" },
      { title: "Approve deploy", desc: "Merge the PR" },
    ],
    aiHeader: "\ud83e\udd16 AI Line Cook's Role",
    aiItems: [
      { title: "Write code", desc: "Implement & modify" },
      { title: "Run tests", desc: "Automated testing" },
      { title: "Submit PR", desc: "Serve the result" },
    ],
    bottomMessage: "You just review.",
  },
  whyPreq: {
    title: "Built for developers who ship",
    subtitle: "Not another project management tool. A real execution platform.",
    items: [
      {
        icon: "\ud83c\udf10",
        title: "Work from anywhere",
        desc: "Send tasks from Telegram, wherever you are. Use your own AI subscription tokens \u2014 no extra platform fees.",
      },
      {
        icon: "\ud83e\udde0",
        title: "Pick your AI per task",
        desc: "Assign Claude, Codex, or Gemini to each task. Match the right AI to the right job, switch anytime.",
      },
      {
        icon: "\ud83d\udcda",
        title: "Multi-project, one dashboard",
        desc: "Manage all your projects in one place. Unlike Linear or Clickup, built specifically for AI-driven dev workflows.",
      },
      {
        icon: "\ud83d\udcca",
        title: "Track everything per project",
        desc: "See exactly how much work was done per project \u2014 AI hours, tasks completed, PRs merged. Full visibility.",
      },
    ],
  },
  features: {
    title: "Essential Kitchen Tools",
    subtitle: "AI completes your code in three steps",
    items: [
      {
        number: "01",
        icon: "\ud83d\udccb",
        title: "Write a Ticket",
        desc: "Send 'Add profile API' on Telegram and a task is automatically created. No complex setup needed.",
      },
      {
        number: "02",
        icon: "\ud83d\udd25",
        title: "Fire! Auto-execute",
        desc: "Just say 'Fire 3953!' and the AI agent writes code in an isolated worktree and creates a PR.",
      },
      {
        number: "03",
        icon: "\u2705",
        title: "Chef's Inspection",
        desc: "Review the AI's PR. Approve for auto-deploy, or Revise and the AI fixes it.",
      },
    ],
  },
  pipeline: {
    title: "From Order to Service",
    subtitle: "Follow the journey of a task",
    steps: [
      { id: "inbox", label: "Order Received", icon: "\ud83d\udce5" },
      { id: "todo", label: "Prep Ingredients", icon: "\ud83e\udd6c" },
      { id: "in_progress", label: "Cooking", icon: "\ud83d\udd25" },
      { id: "review", label: "Plating Review", icon: "\ud83d\udc68\u200d\ud83c\udf73" },
      { id: "done", label: "Served", icon: "\ud83c\udf7d\ufe0f" },
    ],
    blocked: "86'd (Out of stock)",
    blockedTooltip: "\"86'd\" is restaurant slang meaning an item is out of stock or unavailable. Here it means a task is blocked and needs human intervention.",
  },
  multiEngine: {
    ...
    items: [
      {
        ...
        answer: "You always review. PR merging is your choice. work_logs track every execution \u2014 which AI wrote what code, when, and why \u2014 with 100% traceability.",
      },
      {
  ...
  cta: {
    ...
    subtitle: "Queue a task, and AI agents write code, run tests, and create PRs.",
    primary: "Fire Your First Task",
